...
function sendCertificateEmail(donorData, certificateFile) {
  ...
  const announcementBlock = announcementText
    ? `
      <div style="background:#fffbe6;border-left:4px solid #f5c518;padding:18px;border-radius:10px;margin:25px 0;">
        <h3 style="margin:0 0 8px 0;font-size:16px;color:#7a5a00;">Special Announcement</h3>
        <pre style="margin:0;white-space:pre-wrap;font-family:inherit;font-size:14px;color:#333;">${announcementText}</pre>
      </div>
    `
    : '';
        ...
        <div style="padding:40px 30px;">
         ...
         ${announcementBlock}
          ...
          <div style="text-align:center;padding:25px 0;border-top:1px solid #eee;margin-top:35px;">
            ...
            <p style="color:#667eea;font-size:18px;margin:0;">Tag us: @aespainaunion</p>
          </div>
